...
#     e.g. I type: cd /Desktop/Duncans_Grant/FixAlign/RAW_asc
#     If you have a space in any of the folder names, write it in '' quotes
#     e.g. /Desktop/Duncans_Grant/FixAlign/'R Analyses'/RAW_asc/.
#     Then press enter.
...
#    You can either move this file to the folder where your R project and this R script are stored
#    or as I have done in the interest of work flow and tidy folders put a copy of `filenames_script.R` 
#    and moved filenames.csv into a new folder called Expand_start_coordinates. This can be found in the
#    FixAlign folder within Duncans_Grant.
