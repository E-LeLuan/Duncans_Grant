char version[] = "EYEDRY VERSION OF 1/25/2013 (compiled with mingw-GCC)";
/*...................................................
...
1/25/13: minor bug fix - don't add 1 to sequence number when setting up to select a subset of trials (curr_seq)
...
while(fgets(buff,MAXLINEX,gdbuff) != NULL)	/* keep going until EOF */
	...
	{
	if(last_seq > 0)
		curr_seq = atoi(buff+spacebuff(buff,1));	/* previously a bug - I added 1 to this */
...
printf("\nanalyze part: 23: first_seq = %d    24: last_seq           =     %d",*first_seq,*last_seq);
