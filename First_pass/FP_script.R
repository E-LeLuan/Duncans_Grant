...
# Maximal model just eye tracking data
...
#Maximal model able to converge
...
anova(model_alldataR5_null, model_alldata_ranefR5)
check_model(model_alldata_ranefR5)
anova(modelR5, model_alldata_ranefR5)

ranef(model_alldata_ranefR5)
