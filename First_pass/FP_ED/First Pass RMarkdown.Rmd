...
library(readr)
FP_ED_batch_corr <- read_csv("~/Desktop/Duncans_Grant/First_pass/FP_ED/FP_ED_batch_corr.csv")
FP_ED_batch_error <- read_csv("~/Desktop/Duncans_Grant/First_pass/FP_ED/FP_ED_batch_error.csv")
...
All_IDs <- read_csv("~/Desktop/Duncans_Grant/All_IDs.csv")
#View(All_IDs)
